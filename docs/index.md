...
**Les documents de travail (version par version) :**
...
- 📁 Le dossier complet contient les versions précédentes et le template officiel

---

## 📖 Comment ça marche

1. **📤 Dépose tes documents** dans le dossier Drive partagé (lien ci-dessus)
2. **🔄 Le wiki se met à jour** automatiquement (tes brouillons sont convertis en pages web)
3. **🤖 Émile** lit ce wiki et peut relire tes chapitres, suggérer des améliorations, vérifier tes références
...
| 💡 Propositions de solutions | Plan détaillé des dispositifs pédagogiques (7 p.) |
...
- Mettre à jour ce wiki et tes documents
...
> 🕐 **Dernière mise en ligne : 07/08/2026**  
